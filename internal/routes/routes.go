...
func SetupRoutes(app *app.Application) *chi.Mux {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/workouts", app.Middleware.RequireUser(app.WorkoutHandler.HandleCreateWorkoutByID))
	...
	r.Post("/tokens/authentication", app.TokenHandler.HandleCreateTokenRequest)
	return r
}
